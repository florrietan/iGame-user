 ...
 export default {
   mounted(){
    ...
    methods: {
      ...
      async onSubmit() {
         if(!this.checkPhone()||this.UserInfo.LOCATION==""||this.UserInfo.NICKNAME=="")
         {
           this.$message("请输入除简介外的完整、正确用户信息！");
          return;}
        const UpdateData =
        {
        ...
        var url='http://139.196.167.75:5000/api/PersonalInformation';
