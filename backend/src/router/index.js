...
import LeaveMes from '../lookUser/hisLeaveMes.vue'
import creatBar from '../MainPage/createBar.vue'
import BrowsePost from '../MainPage/BrowsePost.vue'
import allBar from '../MainPage/allBar.vue'
import message from '../views/myMessage.vue'
...
const routes = [
  {
    ...
    children:[
      ...
      {path:'/activity',component:()=>import('../views/myActivity.vue')},
      ...
      {path:'/followBar',component:()=>import('../views/followBar.vue')},
      {path:'/message',component:message},
      {path:'/readHistory',component:()=>import('../views/readHistory.vue')}
      ]},
