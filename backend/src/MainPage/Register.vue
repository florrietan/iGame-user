 ...
 // import { ElMessage } from 'element'
  ...
  methods: {
    ...
    async submitRegisterForm() {
      ...
      if(this.ruleForm.userID==='' || this.ruleForm.userName==='') {
      ...
      else if((this.ruleForm.password !== this.ruleForm.confirmPassword) && this.ruleForm.password !== '') {
        ...
        await fetch('http://139.196.167.75:5000/api/Register', {
          ...
          .then(
            res => {
              ...
              else if(this.ruleForm.userID !=='' && this.ruleForm.password !=='')
              {
